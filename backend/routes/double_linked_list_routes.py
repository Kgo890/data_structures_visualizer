...
double_linked_list_router = APIRouter(
...
@double_linked_list_router.post("/add-head")
...
@double_linked_list_router.post("/add-tail")
...
@double_linked_list_router.delete("/delete-back")
...
@double_linked_list_router.delete("/delete-front")
...
@double_linked_list_router.get('/search')
...
@double_linked_list_router.get('/clear')
async def reset():
